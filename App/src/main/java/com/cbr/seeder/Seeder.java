...
public class Seeder {
    public static void main(String[] args) {
        ...
        VIP vip1 = new VIP("CS-5", new ArrayList<>(), "Jason", "08123456789", false, new BasePrice(100.0),
                new HashMap<>());
        VIP vip2 = new VIP("CS-6", new ArrayList<>(), "Chow", "08123456789", true, new BasePrice(100.0),
                new HashMap<>());
        ...
        // FixedInvoice invoice1 = new FixedInvoice(boughtProducts, cust1.getId(), new
        // BasePrice(0.0), new BasePrice(0.0), new BasePrice(0.0), additionalCost, new
        // BasePrice(0.0));
